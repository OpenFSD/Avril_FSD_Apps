...
using ClientAssembly.GameInstance;
...
namespace Avril.ClientAssembly.Graphics
{
    public class GameObjectFactory : IDisposable
    {
        ...
        private Avril.ClientAssembly.GameInstance.Player _player;
        ...
        {
            _player = new Avril.ClientAssembly.GameInstance.Player(
                _models["Player"],
        ...
        public Avril.ClientAssembly.GameInstance.Player Get_player()
        {
            return _player;
        }
    }
