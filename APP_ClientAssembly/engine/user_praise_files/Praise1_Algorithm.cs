...
/*
            ...
            else
            {
                ...
                {
                    case false:
                        if ((mouseState.X != (float)(obj.Get_client().Get_data().Get_settings().Get_ScreenSize_X() / 2))
                            || (mouseState.Y != (float)(obj.Get_client().Get_data().Get_settings().Get_ScreenSize_Y() / 2)))
                        {
                            ...
                            float deltaX = anglePerPixle * (mouseState.X - (obj.Get_client().Get_data().Get_settings().Get_ScreenSize_X() / 2));
                            float deltaY = anglePerPixle * (mouseState.Y - (obj.Get_client().Get_data().Get_settings().Get_ScreenSize_Y() / 2));
                            ...
                            OpenTK.Input.Mouse.SetPosition((double)(obj.Get_client().Get_data().Get_settings().Get_ScreenSize_X() / 2), (double)(obj.Get_client().Get_data().Get_settings().Get_ScreenSize_Y() / 2));
                        }
                        break;
