...
namespace ClientAssembly.GameInstance
{
    public class Hexgon
    {
        ...
        public Hexgon()
        {
            ...
            Console.WriteLine("Avril.ClientAssembly: Map_Default");
        }

        public void Draw_Square(Avril.ClientAssembly.Framework_Client obj, Data data)
        {
            GL.DrawElements(
