...
namespace Avril.ServerAssembly.Praise_Files
{
    public class User_Alg
    {
        ...
        public User_Alg() 
        {
            Set_praise0_Algorithm(new Avril.ServerAssembly.Praise_Files.Praise0_Algorithm());
            while (Get_praise0_Algorithm() == null) { /* Wait while is created */ }

            Set_praise1_Algorithm(new Avril.ServerAssembly.Praise_Files.Praise1_Algorithm());
