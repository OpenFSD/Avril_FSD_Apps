...
namespace Avril_FSD
{
    ...
    public:
        ...
        static void Thread_Concurrency(class Framework_Server* obj, __int8 concurrent_coreId);
        void Do_Concurrent_Algorithm_For_PraiseEventId(class Framework_Server* obj, class Player* player, __int8 ptr_praiseEventId, class Object* ptr_Algorithm_Subset, class Object* ptr_Input_Subset, class Object* ptr_Output_Subset);
