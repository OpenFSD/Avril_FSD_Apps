...
namespace ServerAssembly.GameInstance
{
    public class Hexgon
    {
        ...
        public Hexgon()
        {
            ...
            hexagon_Tile[6] = 0.5;
            hexagon_Tile[7] = Math.Pow(3, 1 / 3) / 2;
            hexagon_Tile[8] = 0;

            hexagon_Tile[9] = -0.5;
            hexagon_Tile[10] = Math.Pow(3, 1 / 3) / 2;
            hexagon_Tile[11] = 0;
            ...
            hexagon_Tile[15] = -0.5;
            hexagon_Tile[16] = -Math.Pow(3, 1 / 3) / 2;
            hexagon_Tile[17] = 0;

            hexagon_Tile[18] = 0.5;
            hexagon_Tile[19] = -Math.Pow(3, 1 / 3) / 2;
            hexagon_Tile[20] = 0;

            hexagon_corner_Colour = new double[21];

            hexagon_corner_Colour[0] = 0.0f;
            hexagon_corner_Colour[1] = 0.0f;
            hexagon_corner_Colour[2] = 0.0f;

            hexagon_corner_Colour[3] = 1.0f;
            hexagon_corner_Colour[4] = 0.0f;
            hexagon_corner_Colour[5] = 0.0f;

            hexagon_corner_Colour[6] = 1.0f;
            hexagon_corner_Colour[7] = 1.0f;
            hexagon_corner_Colour[8] = 1.0f;

            hexagon_corner_Colour[9] = 0.0f;
            hexagon_corner_Colour[10] = 1.0f;
            hexagon_corner_Colour[11] = 0.0f;

            hexagon_corner_Colour[12] = 1.0f;
            hexagon_corner_Colour[13] = 1.0f;
            hexagon_corner_Colour[14] = 1.0f;

            hexagon_corner_Colour[15] = 0.0f;
            hexagon_corner_Colour[16] = 0.0f;
            hexagon_corner_Colour[17] = 1.0f;

            hexagon_corner_Colour[18] = 1.0f;
            hexagon_corner_Colour[19] = 1.0f;
            hexagon_corner_Colour[20] = 1.0f;

            Console.WriteLine("Avril.ServerAssembly: Map_Default");
        }

        public void Draw_Square(Avril.ServerAssembly.Framework_Server obj, Data data)
        {
            GL.DrawElements(
