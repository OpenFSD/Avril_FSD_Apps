namespace Avril.ClientAssembly
{
    ...
    {
        private Avril.ClientAssembly.Execute_Control _execute_Control;
        ...
        {
            Set_execute_Control(new Avril.ClientAssembly.Execute_Control(numberOfCores));
        ...
        public Avril.ClientAssembly.Execute_Control Get_execute_Control()
        {
        ...
        private void Set_execute_Control(Avril.ClientAssembly.Execute_Control execute_Control)
        {
